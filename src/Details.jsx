   ...
   if (props.disease === 'hanta') {
     return (
           <div>
             ...
             <FooterContainer>
               <div>
                 <Typo style={{ "color": '#fff' }} variant="caption">Status: {selected.status}</Typo><br/>
                 <Typo style={{ "color": '#fff' }} variant="caption">Source: <a href={selected.source_url} target="_blank" rel="noopener noreferrer" style={{ color: '#4fc3f7' }}>{selected.source_url}</a></Typo><br/>
               </div>
             </FooterContainer>
           </div>
          )
